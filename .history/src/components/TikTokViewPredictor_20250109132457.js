        ...
        <div className="center-wrapper">
            ...
            <div className="tiktokviewpredictor">
                ...
                <div className="content">
                    ...
                    <p>You can find the source code for this project on GitHub at: <a href="https://github.com/yourusername/TikTokVie\\\\\\\\\\\\\" target="_blank" rel="noopener noreferrer">TikTok View Predictor GitHub Repository</a>.</p>
