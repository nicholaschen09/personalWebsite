        ...
        <div className="center-wrapper">
            ...
            <div className="puzzle">
                ...
                <div className="content">
                    <p>Welcome to the Puzzle project page. This is where you'll find out more about the puzzle project my first year engineering group and I designed and built.</p>
