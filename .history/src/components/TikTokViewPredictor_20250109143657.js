        ...
        <div className="center-wrapper">
            ...
            <div className="tiktokviewpredictor">
                ...
                <div className="content">
                    ...
                    <p>Then I added some other information to the graph for better understanding</p>
                    <img src={code8} alt="code8" className="project-image" />
                    <img src={output8} alt="output8" className="project-image" />
                    <p>I found the mean absolute and squared error for the prediction at the end.set using pandas in python where I then use that to plot the graph</p>
