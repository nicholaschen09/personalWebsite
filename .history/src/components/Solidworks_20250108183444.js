        ...
        <div className="center-wrapper">
            ...
            <div className="engineeringportfolio">
                ...
                <div className="content">
                    ...
                    <p>Throughout my visual communications course, I explored a lot of the tools and solidworks the is a machine learning-based tool that predicts the number of views a TikTok video will receive based on various features.</p>
