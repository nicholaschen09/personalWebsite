        ...
        <div className="center-wrapper">
            ...
            <div className="tiktokviewpredictor">
                ...
                <div className="content">
                    ...
                    <p>Then I began extracting the data from the csv file and putting it into a dataset using pandas in python where I then use that to plot the graph</p>
                    <img src={code8} alt="code5" className="project-image" />
                    <img src={output8} alt="output5" className="project-image" />
                    <p>Then I began extracting the data from the csv file and putting it into a dataset using pandas in python where I then use that to plot the graph</p>
                    <img src={code9} alt="code5" className="project-image" />
                    <img src={output9} alt="output5" className="project-image" />
