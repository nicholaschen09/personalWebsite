...
import original-5 from './original-5.png';
        ...
        <div className="center-wrapper">
            ...
            <div className="psychai">
                ...
                <div className="content">
                    ...
                    <img src={original - 5} alt="original-5" className="project-image" />
                    <p>The chat interface of the website</p>
                    <img src={original - 6} alt="original-6" className="project-image" />
