        ...
        <div className="center-wrapper">
            ...
            <div className="voluntrack">
                ...
                <div className="content">
                    ...
                    <img src={voluntrack1} alt="voluntrack2" className="project-image" />
                    <img src={voluntrack2} alt="voluntrack2" className="project-image" />
                    <img src={voluntrack2} alt="voluntrack3" className="project-image" />
                    <img src={voluntrack2} alt="voluntrack4" className="project-image" />
                    <img src={voluntrack2} alt="voluntrack5" className="project-image" />
