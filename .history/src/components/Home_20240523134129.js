...
const Home = () => {
    return (
        <div className="home">
            ...
            <p> * studying systems design engineering @ university of waterloo</p>
            ...
            <p> * doing an internship @ RBC as an innovation developer</p>
            <p> * studying systems design engineering at the university of waterloo</p>

            <h1>in the past i have...</h1>
            <p>* one a ux design internship @ meta hash capital </p>
