        ...
        <div className="center-wrapper">
            ...
            <div className="basketbin">
                ...
                <div className="content">
                    ...
                    <img src={h} alt="h6" className="project-image" />
                    ...
                    <h3>The BasketBin Website</h3>
                    <p>The BasketBin system is built on a website as well that features real time game statistics that show the player's scores and allows to register and login</p>
