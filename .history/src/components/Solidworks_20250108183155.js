        ...
        <div className="center-wrapper">
            ...
            <div className="engineeringportfolio">
                ...
                <div className="content">
                    ...
                    <h3>About the Project</h3>the is a machine learning-based tool that predicts the number of views a TikTok video will receive based on various features.</p>
