        ...
        <div className="center-wrapper">
            ...
            <div className="tiktokviewpredictor">
                ...
                <div className="content">
                    ...
                    <p>Then I began extracting the data from the csv file and putting it into a dataset using pandas in python where I then use that to plot the graph</p>
                    <img src={code1} alt="code3" className="project-image" />
                    <img src={output1} alt="output3" className="project-image" />
                    <p>Then I began extracting the data from the csv file and putting it into a dataset using pandas in python where I then use that to plot the graph</p>
                    <img src={code1} alt="code4" className="project-image" />
                    <img src={output1} alt="output4" className="project-image" />
                    <p>Then I began extracting the data from the csv file and putting it into a dataset using pandas in python where I then use that to plot the graph</p>
                    <img src={code1} alt="code5" className="project-image" />
                    <img src={output1} alt="output5" className="project-image" />
