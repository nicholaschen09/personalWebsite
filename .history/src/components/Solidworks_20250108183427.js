        ...
        <div className="center-wrapper">
            ...
            <div className="engineeringportfolio">
                ...
                <div className="content">
                    ...
                    <p>Throughout my visual communications course, Isolidworks the is a machine learning-based tool that predicts the number of views a TikTok video will receive based on various features.</p>
