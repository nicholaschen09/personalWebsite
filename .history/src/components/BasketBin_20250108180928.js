        ...
        <div className="center-wrapper">
            ...
            <div className="basketbin">
                ...
                <div className="content">
                    ...
                    <p>The BasketBin system is built on a website as well that features real time game statistics that show the player's scores and allows to register and l</p>
