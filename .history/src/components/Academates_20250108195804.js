        ...
        <div className="center-wrapper">
            ...
            <div className="academates">
                ...
                <div className="content">
                    ...
                    <img src={original} alt="screen1" className="project-image" />
                    <img src={original2} alt="origina" className="project-image" />
                    <img src={original3} alt="screen1" className="project-image" />
                    <img src={original4} alt="screen1" className="project-image" />
